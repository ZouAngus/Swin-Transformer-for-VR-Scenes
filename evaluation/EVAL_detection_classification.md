...
generated by `file_list.py` (both in `tools/data_prep/`). The long-video
...
parsed from the same Excel workbooks by `tools/eval_long_video.py`. All
preparation scripts are archived in `tools/data_prep/` (see its README for
